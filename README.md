...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/yaqd-pmc-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10385&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/yaqd-pmc-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `yaqd-pmc` can be installed with:

```
conda install yaqd-pmc
```

It is possible to list all of the versions of `yaqd-pmc` available on your platform with:
